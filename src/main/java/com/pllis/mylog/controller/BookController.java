...
public class BookController extends BaseController {
    ...
    @GetMapping("/book")
    @ResponseBody
    public ApiResponseHandler<CommonDto.ListResponse<BookVo>> getBookList() {
        CommonDto.ListResponse<BookVo> result = bookService.getBookList();
     ...
     * @return BookDto
     */
    @Operation(summary = "알라딘 책 검색 리스트 조회", description = "리스트 API 입니다.")
